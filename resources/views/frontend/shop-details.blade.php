                        ...
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="product-img" href="{{ asset('upload_images/products/'.$product->image)}}"
                                        title="Product Image">
                                        <img class="d-block w-100"
                                            src="{{ asset('upload_images/products/'.$product->image)}}" alt="1">
                                    </a>
                                </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="single_product_desc">
                        ...
                        <div class="short_overview">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pellem malesuada in
                                nibh selama euismod. Curabitur a rhoncus dui. Nunc lobortis cursus magna utrum faucibus.
